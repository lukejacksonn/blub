...
function Kf(a, b, c) {
  ...
  c ? (b = If(a, b, Df), d.__reactInternalMemoizedMergedChildContext = b, G(K), G(J), I(J, b)) : G(K);
  I(K, c);
}
...
function Mi(a) {
  switch (a.tag) {
    ...
    case 13:
      return G(M), b = a.effectTag, b & 4096 ? (a.effectTag = b & -4097 | 64, a) : null;
...
gk = function (a, b, c) {
  ...
  switch (b.tag) {
    ...
    case 17:
      return d = b.type, e = b.pendingProps, e = b.elementType === d ? e : mg(d, e), null !== a && (a.alternate = null, b.alternate = null, b.effectTag |= 2), b.tag = 1, L(d) ? (a = !0, Jf(b)) : a = !1, vg(b, c), Ug(b, d, e), Wg(b, d, e, c), vi(null, b, d, !0, a, c);
...
var Dk = {
  default: Ck
    ...
    Ek = Dk && Ck || Dk;
var reactDom_production_min = Ek.default || Ek;const {
  createPortal,
  findDOMNode,
  hydrate,
  render,
  ...
  flushSync,
  __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED
} = reactDom_production_min;export default reactDom_production_min;export{__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,createPortal,findDOMNode,flushSync,hydrate,render,unmountComponentAtNode,unstable_batchedUpdates,unstable_createPortal,unstable_renderSubtreeIntoContainer};
//# sourceURL=https://unpkg.com/es-react@16.12.0/react-dom.js